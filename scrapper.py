...
class Crawler:
    ...
    def find_articles(self): 
        ...
        Список статей на сайте https://www.psychologies.ru состоит из двух основных блоков: "razdel-section" и "rubric-anons_list section-three-blocks".
        Сначала пробегается один тип блоков, а потом второй, потому что по смыслу они идентичны,
        а из-за "последовательной" проходки страницы, увеличится количество кода.

        Из-за большой разницы в представлении ссылок на статьи, функция _extract_url() больше не "вытаскивает" ссылки, а скорее "подготавливет" их,
        потому что у каждого типа свой алгоритм добычи необработанных ссылок.
        """
